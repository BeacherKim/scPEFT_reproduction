...
| COVID-19          | [COVID-19](https://mailmissouri-my.sharepoint.com/personal/hefe_umsystem_edu/_layouts/15/onedrive.aspx?ga=1&id=%2Fpersonal%2Fhefe%5Fumsystem%5Fedu%2FDocuments%2FscPEFT%5Fdatasets%2Fcelltype%5Fidentification%2FCOVID%2D19) |
...
run the Tutorial_Identification.ipynb

```python
key_parameters = dict(
    dataset_name="ms",  # Dataset name  （ms/COVID-19/NSCLC)
...
run the Tutorial_MarkerGeneDetection.ipynb

```python
key_parameters = dict(
    dataset_name="COVID-19",  # Dataset name
